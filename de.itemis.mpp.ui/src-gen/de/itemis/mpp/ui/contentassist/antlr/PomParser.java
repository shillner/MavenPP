		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropertyInclusionAccess().getAlternatives(), "rule__PropertyInclusion__Alternatives");
					...
					put(grammarAccess.getImportPropertyInclusionAccess().getGroup(), "rule__ImportPropertyInclusion__Group__0");
					put(grammarAccess.getFilePropertyInclusionAccess().getGroup(), "rule__FilePropertyInclusion__Group__0");
					...
					put(grammarAccess.getPOMAccess().getPropertiesAssignment_4_0(), "rule__POM__PropertiesAssignment_4_0");
					put(grammarAccess.getPOMAccess().getDependenciesAssignment_4_1(), "rule__POM__DependenciesAssignment_4_1");
					put(grammarAccess.getPOMAccess().getScmAssignment_4_2(), "rule__POM__ScmAssignment_4_2");
					put(grammarAccess.getPOMAccess().getRepositoriesAssignment_4_3(), "rule__POM__RepositoriesAssignment_4_3");
					...
					put(grammarAccess.getPropertiesAccess().getInclusionsAssignment_3(), "rule__Properties__InclusionsAssignment_3");
					...
					put(grammarAccess.getImportPropertyInclusionAccess().getPomRefAssignment_2(), "rule__ImportPropertyInclusion__PomRefAssignment_2");
					put(grammarAccess.getFilePropertyInclusionAccess().getPathAssignment_3(), "rule__FilePropertyInclusion__PathAssignment_3");
